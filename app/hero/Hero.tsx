export default function Hero() {
  return (
    <section className="flex h-[100svh] flex-col overflow-hidden md:h-screen">
      ...
      <div className="order-1 flex h-1/2 flex-col justify-end gap-4 px-6 pb-10 md:order-2 md:h-auto md:flex-1 md:flex-row md:items-end md:justify-between md:gap-12 md:px-10 md:pb-8">
